...
impl Material for Lambertian {
    fn scatter(&self,_r_in: &Ray,rec: &mut HitRecord,attenuation: &mut Vec3,scattered: &mut Ray) -> bool {
...
impl Material for Metal {
    fn scatter(&self,r_in: &Ray,rec: &mut HitRecord,attenuation: &mut Vec3,scattered: &mut Ray,) -> bool {
        ...
        *scattered = Ray::new(rec.point3.clone(), reflected + Vec3::random_in_unit_sphere() * self.fuzz);
        *attenuation = self.albedo.clone();
